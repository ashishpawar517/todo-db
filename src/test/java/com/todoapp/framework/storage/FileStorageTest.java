 ...
 * Tests the file-based persistence mechanism.
 */
class FileStorageTest {

    private static final String TEST_FILE_NAME = "test-todo.txt";
    private FileStorage fileStorage;
    private File testFile;

    @BeforeEach
    void setUp() {
        fileStorage = new FileStorage(TEST_FILE_NAME);
    ...
    void testSaveAndLoadEmptyList() {
        fileStorage.save(java.util.List.of());
        List<TodoItem> loaded = fileStorage.load();
    ...
    void testSaveAndLoadSingleItem() {
        ...
        fileStorage.save(java.util.List.of(original));
    ...
    void testSaveAndLoadMultipleItems() {
        ...
        fileStorage.save(java.util.List.of(item1, item2));
    ...
    void testStorageWithNullList() {
        assertThrows(NullPointerException.class, () -> {
            fileStorage.save(null);
        });
    }

    /**
     * Helper method to format a TodoItem as it would appear in storage.
     * This mimics the format used in FileStorage.formatTodoItem().
     */
